...
SOURCES += ./src/camera.cpp ./src/color.cpp ./src/TransferFunctionControlPoint.cpp ./src/CubicSpline.cpp ./src/CubicSplineSegment.cpp ./src/ray.cpp ./src/vector3D.cpp ./src/world.cpp ./src/volume.cpp ./src/helper.cpp ./src/renderengine.cpp 
